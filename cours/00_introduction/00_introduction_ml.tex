...
\begin{tikzpicture}[
    ...
    \node[box] (data1) {Données};
    \node[process, right=1.5cm of data1] (rules1) {Règles\\(code)};
    \node[box, right=1.5cm of rules1] (output1) {Résultats};
...
\begin{itemize}
    ...
    \item Méthodes basées sur des caractéristiques conçues manuellement
\end{itemize}
...
\subsection{Collecte et Exploration des Données}
...
\begin{itemize}
    \item Caractéristiques (features) conçues manuellement
