...
\begin{itemize}
    \item \texttt{14\_demo\_pipeline\_complet.ipynb} : Pipeline ML de bout en bout
    \begin{itemize}
    ...
    \item \texttt{14\_demo\_deployment\_fastapi.ipynb} : Déploiement avec FastAPI
    \begin{itemize}
    ...
    \item \texttt{14\_demo\_monitoring\_mlflow.ipynb} : Tracking et monitoring avec MLflow
    \begin{itemize}
